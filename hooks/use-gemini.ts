...
export function useGemini({ initialMessages = [] }: UseGeminiProps = {}) {
  ...
  // Fix the formatHistoryForGemini function to ensure proper role mapping and order
  // Replace the current formatHistoryForGemini function with this corrected version:
